...
#NEUTRAL
CALL AddCardTrait3(1006,"Item","Weapon","Firearm");
CALL AddCardTrait1(1008,"Item");
CALL AddCardTrait1(1010,"Tactic");
CALL AddCardTrait2(1012,"Item","Relic");
CALL AddCardTrait2(1014,"Item","Relic");
CALL AddCardTrait3(1086,"Item","Weapon","Melee");
CALL AddCardTrait2(1087,"Item","Tool");
CALL AddCardTrait1(1088,"Supply");
CALL AddCardTrait1(1089,"Innate");
CALL AddCardTrait1(1090,"Practiced");
CALL AddCardTrait1(1091,"Practiced");
CALL AddCardTrait1(1092,"Innate");
CALL AddCardTrait1(1093,"Innate");
CALL AddCardTrait2(1094,"Item","Armor");
CALL AddCardTrait2(1095,"Item","Relic");

#WEAKNESS
CALL AddCardTrait1(1007,"Task");
CALL AddCardTrait2(1009,"Item","Tome");
CALL AddCardTrait1(1011,"Task");
CALL AddCardTrait1(1013,"Spell");
CALL AddCardTrait1(1015,"Madness");
CALL AddCardTrait1(1096,"Madness");
CALL AddCardTrait1(1097,"Madness");
CALL AddCardTrait1(1098,"Curse");
CALL AddCardTrait1(1099,"Madness");
CALL AddCardTrait1(1100,"Madness");
CALL AddCardTrait2(1101,"Humanoid","Criminal");
CALL AddCardTrait3(1102,"Humanoid","Cultist","SilverTwilight");
CALL AddCardTrait2(1103,"Humanoid","Detective");
